<?php
    ...
    //require dbconnection page
    require("dbconnect.php");

    //create variable to pick up session variable
    $firstname = $_SESSION['firstname'];
    $othernames = $_SESSION['surname'];

    //require user to be logged in
    require("logged_in_db.php");
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Vote</span></a>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name"><?php echo $firstname?>&nbsp;<?php echo $othernames?></span>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Dashboard</h2>
												<p>Welcome <?php echo $firstname?><span class="bread-ntd">&nbsp;<?php echo $othernames?></span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="breadcomb-wp">
											<div class="breadcomb-ctn">
                                                ...
                                                <form action="vie.php" method="POST">
                                                    ...
                                                    <span class="label"><h5>Election</h5></span>
                                                        <select class="form-control " name="election" id="election">
                                                            <?php
                                                                $sql = "SELECT * FROM election WHERE active = 1 ";
                                                                $result = mysqli_query($dbconnect, $sql);
                                                                
                                                                while ($elections = mysqli_fetch_assoc($result))
                                                                {
                                                                    ?>
                                                                        <option  value= "<?php echo $elections['id']?>" ><?php echo $elections['name'] ?> </option>
                                                                    <?php
                                                                }
                                                            ?>
                                                    ...
                                                    >
                                                    <div class="form-group">
                                                    <span class="label"><h5>Position</h5></span>
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="reg_submit">Register</button>
                                                </form>
                                                <?php
                                                    ...
                                                    if(isset($_POST['reg_submit']))
                                                    {
                                                        ...
                                                        echo $position;
                                                        echo $election;
                                                        $sql_cand_check = "SELECT * FROM candidate WHERE user_id = '$user_id'";
                                                        $cand_res = mysqli_query($dbconnect, $sql_cand_check);
				                                        $rows = mysqli_num_rows($cand_res);
                                                        if($rows<1)
                                                        {
                                                            $sql = "INSERT INTO candidate (id, user_id, election_id, position_id) VALUES (NULL,'$user_id','$election', '$position')";
                                                            $result = mysqli_query($dbconnect, $sql);
                                                            if($result)
                                                            {
                                                                ...
                                                                <span class="label label-success">Registration was completed successfully.</span><?php
                                                            }
                                                            else{
                                                            ...
                                                            $vied = mysqli_fetch_assoc($cand_res);
                                                            $id = $vied['position_id'];
                                                            $position_vied_sql = "SELECT * FROM position WHERE id = '$id'";
                                                            $res = mysqli_query($dbconnect, $position_vied_sql);
                                                            $res_assoc = mysqli_fetch_assoc($res);
                                                          
                                                            ?>
                                                            <p>You already vied for <?php echo $res_assoc['name']?></p>
                                                            <?php
                                                        }
